    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <div className="w-full max-w-sm bg-white border border-gray-200 rounded-lg p-8 shadow-sm">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 border border-gray-300 rounded px-4 py-2 text-sm font-medium hover:bg-gray-50 mb-4"
        >
        ...
        <p className="text-center text-sm text-gray-500 mt-4">
          Hesabınız yok mu?{" "}
          <Link href="/auth/register" className="text-[#d0021b] font-semibold hover:underline">
            Kayıt Ol
          </Link>
        </p>
      </div>
